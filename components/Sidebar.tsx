...
const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  const menuItems: { id: ViewName; label: string; icon: any; highlight?: boolean; adminOnly?: boolean }[] = [
    ...
    { id: 'audit-wizard', label: 'Iniciar Inspección', icon: ClipboardCheck },
    { id: 'new-visit', label: 'Registrar Visita', icon: Briefcase },
    { id: 'cctv-inventory', label: 'Protección CCTV', icon: Video },
    { id: 'physical-inventory', label: 'Infraestructura', icon: Warehouse },
    { id: 'asset-control', label: 'Control de Activos', icon: KeyRound },
    { id: 'technical-inventory', label: 'Equipos Técnicos', icon: Warehouse },
    ...
    <>
      ...
      `}>
        ...
        <div className="p-4 border-t border-white/5 bg-slate-900/50">
          ...
          <p className="text-center text-[9px] text-slate-600 font-bold mt-3 uppercase tracking-widest opacity-50">
            v{import.meta.env.VITE_APP_VERSION || '11.0'}
          </p>
        </div>
      </aside>
    </>
