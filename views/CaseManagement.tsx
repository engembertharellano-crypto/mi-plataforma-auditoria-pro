...
const MonthlySummary: React.FC<MonthlySummaryProps> = ({ 
  ...
  const filteredData = useMemo(() => {
    ...
    // Buscamos quién es el investigador asignado a la zona seleccionada
    const investigatorOfZone = users.find(u => u.zone === selectedZone)?.fullName;
    ...
    return {
      ...
      cases: cases.filter(filterCasesByInvestigatorOrZone)
    };
  }, [selectedZone, pharmacies, audits, cctvRecords, physicalRecords, managementRecords, cases, users]);
